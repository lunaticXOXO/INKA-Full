        ...
        max-width="1000">
            <v-data-table
                ...
                <template v-slot:[`item.aksi`]="{ item }">
                    ...
                    <div v-else>
                        <v-btn class="mx-1" x-small color="green" @click="editStasiunKerja(item)">
                            <v-icon small dark>mdi-pencil</v-icon>
                        </v-btn>
                        <v-btn class="mx-1" x-small color="red" @click="deleteStasiunKerja(item)">
